...
3. **Extend before using** — If the design system doesn't cover a scenario, extend it first (`design-system/components/` or `tokens/`), then use in business code
...
Preview: `http://localhost:3099/design-system`
